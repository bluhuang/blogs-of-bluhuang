...
> **目标**：在 Mac 和 iPhone 之间配置完全无线、可续签的 iOS App 安装环境，使得远程构建 `.ipa` 后，通过手机上的 SideStore 直接安装，无需 USB。
...
- **iLoader** 是一个图形化工具，用于将 SideStore 安装到 iPhone。
...
- `iLoader.dmg` – 用于在 Mac 上将 SideStore 安装到 iPhone 的工具
