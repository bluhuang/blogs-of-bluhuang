...
> 正确用法是**串联**而非替代——Bi‑Encoder 先快速召回候选集，Cross‑Encoder 再精细排序。用通俗例子说明：“Bi‑Encoder 是海选，速度第一；Cross‑Encoder 是决赛，精度第一。”
...
|------|--------|-----------|----------|----------|----------|
| **Rerank 4 商业版** (Pro/Fast) | — | 33K | 闭源（商业 API） | 托管服务，多语言覆盖广，精度领先 | Fast版低延迟，Pro版精度最高 |
...
| 场景 | 推荐模型 | 理由 |
|------|----------|------|
| **最快落地、不折腾运维** | 商业版 Rerank 4（Pro / Fast） | 托管 API，精度领先，多语言覆盖广，按量付费 |
...
- RAG学习之-Rerank 技术详解：从入门到掌握（CSDN）
...
- 商业版 Rerank 4 Fast vs BGE Reranker v2 M3（Agentset）
