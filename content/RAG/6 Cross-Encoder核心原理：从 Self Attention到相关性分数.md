...
lastmod: 2026-06-10T14:49:54+0800
---
...
| 模型 | 参数量 | 特点 | 适用场景 |
|------|--------|------|----------|
| **中文社区主流 Reranker** | ~560M | 中文社区主流，Apache 2.0，量化后 <200MB | 中文 + 自托管，平衡精度与资源 |
| **闭源 API Rerank 模型** | 闭源 API | 精度领先，多语言，按量付费 | 最快落地，不折腾运维 |
| **MiniLM‑L‑6‑v2** | 22M | 超轻量，CPU 可跑，MIT 协议 | 英文通用，边缘部署，学习入门 |
| **多语言长上下文 Reranker** | 4B | 100+ 语言，Apache 2.0，32K 上下文 | 多语言 + 长文档 + 开源 |
| **ColBERT v2** | 110M | Token‑级后期交互，高吞吐 | 大规模英文知识库精排 |

> **选型建议**：从**精度、延迟、成本、隐私**四个维度权衡。中文技术文档首选中文社区主流模型，追求精度但不想自托管选闭源 API 模型，学习入门用 MiniLM。
