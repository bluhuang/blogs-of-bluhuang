...
如果没有平滑常数，排名第 1 的文档得分为 1，排名第 2 得分为 0.5，差距过大。k=60 使排名 1 得 1/61≈0.0164，排名 2 得 1/62≈0.0161，差距缩小。这样单一检索器的极端高分不会压过其他信号。相关论文验证了 60 在多数据集上的最优性。
...
- **用自定义业务测试集**，跑出量化结果。给出具体数字（如“混合检索使 Hit Rate@3 从 0.65 提升到 0.82”）。
