...
ReAct（Reasoning + Acting）是由谷歌研究院和普林斯顿大学于 2022 年提出的智能体框架，其核心创新在于让 LLM 交替生成**推理轨迹**与**任务操作**，模拟人类解决问题时的“思考-行动-观察”循环。
...
ReAct（Reasoning + Acting）正是为解决此问题而提出：在推理过程中，显式地交替输出“思考内容（Thought）”和“行动指令（Action）”，再利用环境反馈（Observation）更新后续推理。
