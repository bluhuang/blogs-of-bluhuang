...
BM25 的公式源自经典的 IR 概率模型演变。理解其结构即可——它不仅仅是词频计数，还考虑了**饱和度**和**文档长度**两个核心维度。
...
- **用你的 NQ 或自定义业务测试集**，跑出量化结果。评估时给出具体数字（如“混合检索使 Hit Rate@3 从 0.65 提升到 0.82”）。
...
| **中文 BM25 为什么需要分词？** | 英文有天然空格，中文需要先切分成词语才能进行词频统计。 |
| **jieba 和其他分词器有什么区别？** | jieba 简单快速适合原型；pkuseg/HanLP 精度更高但开销大。 |