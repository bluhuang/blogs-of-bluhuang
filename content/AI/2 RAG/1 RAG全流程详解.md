...
**建议**：能对比不同分片策略的优劣，并知道如何根据文档类型（技术文档、对话记录、法律条文）选择策略。
...
| `bge-large-zh` | 1024 | 中文表现优秀，开源 | 中文文档 |
...
**常见问题**："你们用的什么 Embedding 模型？为什么选它？和某些闭源模型对比过吗？"
...
**技术选型建议**："中文场景选 bge-large-zh，因为 MTEB 中文榜单排名靠前，而且开源可以本地部署，不用走 API。如果是英文场景或对延迟不敏感，商用 embedding 更方便。"
...
| 某闭源 Rerank API | 闭源，调用简单，效果好 | 商业应用 |
