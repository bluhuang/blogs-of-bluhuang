...
光说不练假把式。Anthropic 发布的终端编程神器 **Claude Code**，直接把 Skills 机制带火了。以它为例，看看真实项目里是怎么玩 Skills 的。
...
2. **SKILL.md 里面写了啥？** 之前说过，一个优秀的 Skill 分为“头部配置”和“技能主体”。在 Claude Code 里，它是这么写的：
