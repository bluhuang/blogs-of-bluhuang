...
![Plan and Execute 示意](<什么是 Agent？-24f0a668b5e94edcb36dba3a103ba662.png>)
...
这些问题催生了另一种工作模式： **Plan and Execute（规划-执行模式）**。

核心思路用一句话说清楚： **先让大模型把整个任务规划成一份清单，再逐步按清单执行，而不是走一步看一步。**

![Plan and Execute 流程](<什么是 Agent？-9b779638ec1f5dcada30ce8b1c298fef.png>)
...
![执行阶段示意](<什么是 Agent？-3f10a22a70a34464b0b4dee0e977eb82.png>)
...
![整体流程图](<什么是 Agent？-2c18f6e922ac932e787d79bf617d8e43.png>)
...
![真实挑战](<什么是 Agent？-d4465e51e01ad06201c516243245