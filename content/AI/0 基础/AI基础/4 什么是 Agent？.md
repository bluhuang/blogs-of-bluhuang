...
前两章讲了大模型的底层逻辑，也讲了如何写好 Prompt。到现在，你已经知道大模型是个"超级大脑"，能理解意图、进行逻辑推理、生成高质量内容。

但它只能言语，无法行动：它能说"你应该查一下慢查询日志"，但它自己查不了；它能分析"这个 API 可能是瓶颈"，但它发不了报警、关不了开关、也打不开任何一个文件。
...
![](<attachments/什么是 Agent？-d4465e51e01ad06201c516243245fb66.png>)
...
![](<attachments/什么是 Agent？-269502a91fac34d5ec722746e7aeb4d3.png>)
