---
title: "11 什么是Harness工程？"
---

### 📌 本章重点总结

1. **概念来源**：由某工程师在 2026 年 2 月提出，随后被某机构官方博客推广。核心思想是“设计一套包裹模型的外部环境，让 Agent 稳定交付”。
2. **AI 工程重心的三次演进**：
...
这个文件本身啥也不是。给它配一个 HTTP 接口，它就成了所谓的「大模型 API 服务」。给这个 API 套一个聊天界面，它就成了聊天工具；套一个代码编辑器，它就成了各种 AI IDE。
