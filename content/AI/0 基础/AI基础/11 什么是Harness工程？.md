...
> 系统里除了模型本身之外，其他所有决定稳定性的东西，都属于 Harness。
...
> 先是一位工程师在工程博客里提出，接着被顶级 AI 公司官方认可和放大，然后整个圈子都开始讨论。
...
提示词没毛病、上下文也没毛病，可它就是做不稳。正是在这个背景下，那位工程师的那篇博客和某公司的那个百万行代码实验几乎同时出现，Harness Engineering 就这么被推到了台前。
