...
### 实战加餐：以近期爆火的终端编程工具为例，看看 Skills 到底有多强？

光说不练假把式。今年（2026年）某团队发布的终端编程神器，直接把 Skills 机制带火了。咱们就以它为例，看看真实项目里是怎么玩 Skills 的。
...
2. **SKILL.md 里面写了啥？** 咱们刚才说了，一个优秀的 Skill 分为“头部配置”和“技能主体”。在这个案例里，它是这么写的：
