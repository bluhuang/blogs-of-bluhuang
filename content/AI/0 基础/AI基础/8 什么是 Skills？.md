...
光说不练假把式。2026 年 Anthropic 发布的终端编程神器 **Claude Code**，直接把 Skills 机制带火了。咱们就以它为例，看看真实项目里是怎么玩 Skills 的。
...
* **Skills（技能）：** 是上层的业务封装（2026 年初的新宠），它将 Prompt 指令和 MCP 工具组合在一起，按清晰的 **目录结构** 管理起来，变成了 AI 可以随拿随用、彻底告别重复劳动的“ **标准工作流**”。
